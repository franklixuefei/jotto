...
public interface IWordList 
{
    ...
    * @return the position of aWord in the list if the word is contained in the list; -1 otherwise. */
   public int contains(String aWord);
   
   /** The number of words in the list.
    * @return the number of words in the list. */
   public int numWords();

   /** Get the i-th word in the list.
    ...
    * @param difficulty The required difficulty, one of 0..2; if > 2, call randomWord()
